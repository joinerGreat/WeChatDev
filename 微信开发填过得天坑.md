...
```
#### 另一种方法，多使用封装方法，然后再程序运行的时候调用方法，而不是，所有代码都在逻辑中写出来。记得将代码封装成方法。减少代码冗余。

#### 同时使用被动回复接口和客服回复接口，至于客服回复接口的相关接口权限，请自行参考微信开发官方文档

#### 其实网络上提供了一种ob缓存的解决方法，但是这种方法我试过，反正对于我的代码没有用，但是大家可以自行[参考此文档](https://blog.csdn.net/wanlinzan/article/details/64123832)
```php
